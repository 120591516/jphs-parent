...
public interface VoucherService extends BaseService<Voucher> {
     ...
     * @return
     */
    Double getGoodsPrice(String voucherUseId, String pricePartId, String nurseId, Integer type);
     ...
     * @return
     */
    List<Map<String, Object>> getUserVoucherNum(String userId);
     ...
     * @return
     */
    byte[] userConvertVoucher(String id,String code,String type);
     ...
     * @return
     */
    int getActiveCenterVoucher(String userId,String grantName);
