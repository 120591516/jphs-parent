...
public class FamilyOrderServiceImpl extends BaseServiceImpl<FamilyOrder> implements FamilyOrderService {
	 ...
	 * @return
	 */
	public FamilyOrder familyOrderOneId(FamilyOrder familyOrder){
		return familyOrderDao.familyOrderOneId(familyOrder);
	}
	 ...
	 * @return
	 */
	public Page<FamilyOrder> familyOrderIndex(FamilyOrder familyOrder){
		return familyOrderDao.familyOrderIndex(familyOrder);
	}
	...
	public byte [] duFamily(String fmId, String wxNo, Double payParice, String userId,String name,String fpId,String fpTitle,
	    ...
	    public String doInTransaction(final TransactionStatus status) {
	         try {
				...
				familyOrder.setFamilyModeId(fmId);
