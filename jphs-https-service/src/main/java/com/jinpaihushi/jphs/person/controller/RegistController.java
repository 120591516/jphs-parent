...
public class RegistController {
    ...
    public byte[] regist(HttpSession hs, HttpServletRequest req, HttpServletResponse resp, User user,
        ...
        try {
            ...
            if (type_id == 0) {
                img.setUrl("https://resource.goldnurse.com/images/default_head/yonghu_nv.jpg");
            }
            else {
            ...
            if (type_id == 0) {
                ...
                nurseJPushService.jpushAlias("您已成为“金牌护士”。在APP个人中心完成“资质认证后”即可开始服务。", user_login.getId(), "0");
            }
