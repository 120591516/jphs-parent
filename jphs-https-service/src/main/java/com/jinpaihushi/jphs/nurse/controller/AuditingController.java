    ...
    public byte[] getWapIndex(HttpServletRequest req, HttpServletResponse resp, String authCode,String userId){
    	try {
	        ...
	        if (Util.debugLog.isDebugEnabled()) {
   			...
   			if(nurseJobtitle_list == null || nurseJobtitle_list.size() < 1){
   				NurseJobtitle nurseJobtitle_s = new NurseJobtitle();
   				nurseJobtitle_s.setCreatorId(userId);
   				nurseJobtitle.setStatus(1);
   				nurseJobtitle_list = nurseJobtitleService.list(nurseJobtitle_s);
   			}
