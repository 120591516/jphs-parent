...
public class NurseCommodityController {
    ...
    @ResponseBody
    public byte[] insertNurseCommodity(NurseCommodity nurseCommodity) {
        try {
            if (Util.debugLog.isDebugEnabled()) {
                Util.debugLog.debug("commodityOrder.insertNurseCommodity.json,userId =" + nurseCommodity.getCreatorId()
                        + ",commodityId = " + nurseCommodity.getCommodityId());
            }
            ...
            Util.failLog.error("commodityOrder.insertNurseCommodity.json,userId =" + nurseCommodity.getCreatorId()
                    + ",commodityId = " + nurseCommodity.getCommodityId(), e);
        }
        return null;
    }
    ...
    @ResponseBody
    public byte[] updateBrowser(NurseCommodity nurseCommodity) {
        try {
            if (Util.debugLog.isDebugEnabled()) {
                Util.debugLog.debug("commodityOrder.updateBrowser.json,userId =" + nurseCommodity.getCreatorId()
                        + ",commodityId = " + nurseCommodity.getCommodityId());
            }
            ...
            Util.failLog.error("commodityOrder.updateBrowser.json,userId =" + nurseCommodity.getCreatorId()
                    + ",commodityId = " + nurseCommodity.getCommodityId(), e);
        }
        return null;
    }
    ...
    @ResponseBody
    public byte[] updateShareNumber(NurseCommodity nurseCommodity) {
        try {
            if (Util.debugLog.isDebugEnabled()) {
                Util.debugLog.debug("commodityOrder.updateShareNumber.json,userId =" + nurseCommodity.getCreatorId()
                        + ",commodityId = " + nurseCommodity.getCommodityId());
            }
            ...
            Util.failLog.error("commodityOrder.updateShareNumber.json,userId =" + nurseCommodity.getCreatorId()
                    + ",commodityId = " + nurseCommodity.getCommodityId(), e);
        }
        return null;
    }
