...
public class Commodity extends BaseModel implements Predicate<Commodity>, Updator<Commodity> {
    ...
    private CommodityPrice commodityPrices;
    ...
    public CommodityPrice getCommodityPrices() {
        return commodityPrices;
    }

    public void setCommodityPrices(CommodityPrice commodityPrices) {
    ...
    private String commodityTypeParent;
    ...
    public String getCommodityTypeParent() {
        return commodityTypeParent;
    }

    public void setCommodityTypeParent(String commodityTypeParent) {
    ...
    public String toString() {
        return new StringBuilder().append("Commodity{").append("id=").append(id).append(",businessId=")
                .append(businessId).append(",commodityTypeId=").append(commodityTypeId).append(",title=").append(title)
                .append(",subTitle=").append(subTitle).append(",model=").append(model).append(",content=")
                .append(content).append(",quality=").append(quality).append(",privacy=").append(privacy)
                .append(",security=").append(security).append(",parameter=").append(parameter)
                .append(",supportVoucher=").append(supportVoucher).append(",limitNumber=").append(limitNumber)
                .append(",protectDay=").append(protectDay).append(",sort=").append(sort).append(",remark=")
                .append(remark).append(",status=").append(status).append(",createTime=").append(createTime)
