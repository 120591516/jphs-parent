...
public class CommodityOrderInfo extends BaseModel
        implements Predicate<CommodityOrderInfo>, Updator<CommodityOrderInfo> {
    ...
    /** 活动id */
    @Length(max = 50, message = "{commodityOrderInfo.activityPromotionId.illegal.length}")
    ...
    public String toString() {
        return new StringBuilder().append("CommodityOrderInfo{").append("id=").append(id).append(",commodityOrderId=")
                .append(commodityOrderId).append(",commodityId=").append(commodityId).append(",userId=").append(userId)
                .append(",profit=").append(profit).append(",title=").append(title).append(",oldPrice=").append(oldPrice)
                .append(",price=").append(price).append(",commodityPriceName=").append(commodityPriceName)
                .append(",commodityModel=").append(commodityModel).append(",number=").append(number).append(",remark=")
