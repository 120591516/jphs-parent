...
public interface GoodsService extends BaseService<Goods> {
    ...
    boolean updateGoods(Goods goods, ListPrice listPrice, ImageType imageType,String creator_id,String creator_name);
     ...
     * @return
     */
    List<Map<String, Object>> getIfProductGoodsList(Goods goods);
