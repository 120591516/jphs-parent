...
<form class="form-horizontal" id="productForm" method="post" data-role="validate-form" action="/family/consultation/insert.jhtml">
	<div class="marage_right_content">
		<div class="clearfix">
		<jphs:hasPermission url="/family/consultation/insert.jhtml">
