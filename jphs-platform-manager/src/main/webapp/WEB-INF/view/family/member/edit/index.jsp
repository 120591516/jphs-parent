...
<div style="margin: 10px 10px 10px 10px;">
	...
	<form class="add_body" id="familyMemberForm" method="post" data-role="validate-form"
		action="/family/member/insert.jhtml">
		<div class="tool_form">
			<div class="wf_btn_left">
				<afocus:privilege url="/family/member/save.jhtml">
