...
<div style="margin: 10px 10px 10px 10px;">
	...
	<form class="add_body" id="familyVoucherForm" method="post" data-role="validate-form"
		action="/family/voucher/insert.jhtml">
		<div class="tool_form">
			<div class="wf_btn_left">
				<afocus:privilege url="/family/voucher/save.jhtml">
