...
<div class="common_left">
	...
	<dl>
		...
		<jphs:hasAnyPermission
			url="/commodity/index.jhtml,/business/index.jhtml">
			<dt class="public_left_active">
			...
			<div class="public_left_list">
				...
				<jphs:hasAnyPermission url="/business/index.jhtml">
					<dd>
			 ...
			 <jphs:hasAnyPermission url="/commodity/type/parent/index.jhtml">
					<dd>
						<a href="/commodity/type/parent/index.jhtml"><img
							src="/static/images/Group7.png" />商品一级分类</a>
					</dd>
					</jphs:hasAnyPermission>
					<jphs:hasAnyPermission url="/commodity/type/index.jhtml">
					<dd>
