		...
		<c:choose>
			...
			<div class="norm_service" <%-- style="display: ${goods.gradeType == 0 || goods.gradeType == null ?'block':'none'};" --%> >
				<c:forEach var="priceOne_g" items="${goods.priceGrade }" varStatus="status_g">
					...
					<div style="margin-top:20px;margin-left:88px;margin-bottom:20px">医院名称：<input style="width: 200px;" type="text" id="gradeName${status_g.index }" value="${priceOne_g.gradeName }" name="price[${status_g.index }].gradeName" /></div>
