...
<div class="common_right_title">
	<img src="/static/images/yousanjiaox.png" />服务管理 <i class="public1-horn-45"></i>品类管理 <i class="public1-horn-45"></i>
	品类详情
</div>
<form class="form-horizontal add_body" id="platformForm" method="post"
	data-role="validate-form" action="/product/insert.jhtml">
