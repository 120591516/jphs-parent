...
<div class="common_right_title">
	<img src="/static/images/yousanjiaox.png" />服务管理 <i class="public1-horn-45"></i>品类管理<i class="public1-horn-45"></i>品类列表 
</div>
...
<div class="marage_right_content">
	...
	<button id="redirectAddPage" type="button" class="public-info">新建品类</button>
	</jphs:hasPermission>
