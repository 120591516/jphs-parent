...
<div class="details_box clearfix">
	...
	<div class="col-md-6" style="border-right: 1px solid #e0e0e0;">
		...
		<p>
			<span>所属频道：</span> ${informationChannel} 
		</p>
		<p>
		...
		<p style="padding-left:30px"><span style="margin-left:0">简介：</span>
	${information.brief }</p>
...
<div class="details_box clearfix" style="width:800px;margin:0 auto">
