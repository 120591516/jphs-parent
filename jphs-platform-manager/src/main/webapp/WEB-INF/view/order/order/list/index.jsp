...
<div class="common_right_title">
	<img src="/static/images/yousanjiaox.png" />订单管理<i class="public1-horn-45"></i>服务订单<i class="public1-horn-45"></i>订单列表
</div>
...
<div class="marage_right_content">
	<!-- 左对齐按钮 -->
	<jphs:hasPermission url="/order/getExcel.jhtml">
			...
			安全验证
				...
				<div class="form-group">
						...
						<div class="controls  col-md-6">
							 ${fn:substring(session_user.userPhone, 0, 3)}****
							   ${fn:substring(session_user.userPhone, 7, 11)}
						</div>
					</div> 
