...
<div id="annual-quantity-year">
	<div class="marage_right_title">
		<div class="form-group" style="background: #fff">
			...
			<jphs:hasPermission url="/person/statistics/userRegisterByAnnual.jhtml">
			<button id="annual-next-year" class="search_btn"
				value="/person/statistics/userRegisterByAnnual.jhtml" style="display: none;">下一年</button>
			</jphs:hasPermission>
			&nbsp;&nbsp;
			...
			<button id="annual-last-year" class="search_btn"
				value="/person/statistics/userRegisterByAnnual.jhtml">上一年</button>
			</jphs:hasPermission>
		</div>
	</div>
