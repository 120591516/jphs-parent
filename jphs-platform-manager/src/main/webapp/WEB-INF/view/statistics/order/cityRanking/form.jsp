...
<div id ="quantity-year">
	<div class="marage_right_title">
		<div class="form-group" style="background: #fff">
			<jphs:hasPermission url="/order/statistics/cityRanking.jhtml">
			<button id="next-year" style="display:none;" class="search_btn" value="/order/statistics/cityRanking.jhtml">下一年</button>
			</jphs:hasPermission>
			&nbsp;&nbsp;
			<button id="this-year" class="search_btn" style="width: 70px;"></button>
			&nbsp;&nbsp;
			<jphs:hasPermission url="/order/statistics/cityRanking.jhtml">
			<button id="last-year"  class="search_btn" value="/order/statistics/cityRanking.jhtml">上一年</button>
			</jphs:hasPermission>
		</div>
	</div>
