...
<link href="/static/css/build/build_standalone.less" rel="stylesheet" type="text/plain" />
<link href="/static/css/build/build.less" rel="stylesheet" type="text/plain" />
<link href="/static/css/less/datetimepicker.less" rel="stylesheet" type="text/plain" />
...
<c:forEach var="item" items="${css}">
	<link href="<c:out value='${item}'></c:out>" rel="stylesheet" type="text/css" /> 	
</c:forEach>
