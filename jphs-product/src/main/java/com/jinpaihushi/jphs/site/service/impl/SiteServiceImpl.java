...
public class SiteServiceImpl extends BaseServiceImpl<Site> implements SiteService {
     ...
     * @return
     */
    public List<Map<String, Object>> getSiteAllList(Site site) {
        return siteDao.getSiteAllList(site);
    }
    ...
    public List<Map<String, Object>> Test() {
        Site parm = new Site();
        parm.setId(UUIDUtils.getId());
        parm.setName("Demo");
        parm.setCreatorId("Demo");
        parm.setCreatorName("Demo");
        parm.setUrl("Demo");
        parm.setRemark("Demo");
        parm.setStatus(1);
        parm.setCreateTime(new Date());
        siteDao.insert(parm);
        Site site = siteDao.loadById("7");
        site.setStatus(-1);
