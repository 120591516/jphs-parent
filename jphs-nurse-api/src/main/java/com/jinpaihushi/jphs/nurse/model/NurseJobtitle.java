...
public class NurseJobtitle extends BaseModel implements Predicate<NurseJobtitle>, Updator<NurseJobtitle> {
     ...
     * 职称类型名称
     */
    private String jobtitleTypeName;
    ...
    public String getJobtitleTypeName() {
        return jobtitleTypeName;
    }

    public void setJobtitleTypeName(String jobtitleTypeName) {
        this.jobtitleTypeName = jobtitleTypeName;
    }
    ...
    public String toString() {
        return new StringBuilder().append("NurseJobtitle{").append("id=").append(id).append(",name=").append(name)
                .append(",sfz=").append(sfz).append(",sex=").append(sex).append(",hospital=").append(hospital)
                .append(",departmentId=").append(departmentId).append(",jobtitleId=").append(jobtitleId)
                .append(",workYears=").append(workYears).append(",education=").append(education).append(",address=")
                .append(address).append(",creatorId=").append(creatorId).append(",creatorName=").append(creatorName)
    ...
    public boolean test(NurseJobtitle t) {
        ...
        return (this.id == null || this.id.equals(t.id)) && (this.name == null || this.name.equals(t.name))
                && (this.sfz == null || this.sfz.equals(t.sfz)) && (this.sex == null || this.sex.equals(t.sex))
