...
public class CycleTimeUtils {
    ...
    public static String formart(Date calendar) {
    ...
    public static void main(String[] args) {
        List<String> list = getDatesBetweenTwoDate("2017-06-19", "2017-09-25");
        for (int i = 0; i < list.size(); i++) {
            System.out.println("替换之前：" + list.get(i));
            System.out.println("替换之后：" + list.get(i).replace("-", ""));
        }

        System.out.println(new Date("20/Nov/2017:10:35:31"));
    }
}
