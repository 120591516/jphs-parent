...
public class HasAnyPermissionTag extends ConditionalTagSupport {
    ...
    protected boolean condition() throws JspTagException {
        ...
        Object systemUser = (Object) session.getAttribute("session_user");
        if (systemUser != null) {
            ...
            if (StringUtils.isNotEmpty(url)) {
                return UrlUtils.hasAnyPermission(urlList, url);
            }
        }
        return false;
