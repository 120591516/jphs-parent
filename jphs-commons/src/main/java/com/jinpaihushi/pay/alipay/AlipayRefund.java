...
public class AlipayRefund {
    ...
    public static Map doGet(String trade_no, String refund_fee) throws ServletException, IOException {
        ...
        sParaTemp.put("service", AlipayConfig.service1);
        ...
        // 建立请求
        String sHtmlText = AlipaySubmit.buildRequestRefund(sParaTemp);
        Map map = null;
        try {
            map = XMLUtil.doXMLParse(sHtmlText);
        }
