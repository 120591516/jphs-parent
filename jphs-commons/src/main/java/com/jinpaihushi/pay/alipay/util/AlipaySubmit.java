package com.jinpaihushi.pay.alipay.util;
...
import com.jinpaihushi.pay.alipay.sign.MD5;
import com.jinpaihushi.pay.alipay.util.httpClient.HttpProtocolHandler;
import com.jinpaihushi.pay.alipay.util.httpClient.HttpRequest;
import com.jinpaihushi.pay.alipay.util.httpClient.HttpResponse;
import com.jinpaihushi.pay.alipay.util.httpClient.HttpResultType;
...
public class AlipaySubmit {
     ...
     * @return 要请求的参数数组
     */
    private static Map<String, String> buildRequestParaRefund(Map<String, String> sParaTemp) { // 除去数组中的空值和签名参数
        ...
        sPara.put("sign_type", AlipayConfig.sign_type2);
        return sPara;
    }

    private static Map<String, String> buildRequestPara(Map<String, String> sParaTemp) {
        String sign = sParaTemp.get("sign").toString();
     ...
     */
    public static String buildRequestTest(Map<String, String> sParaTemp) throws UnsupportedEncodingException {
        // 待请求参数数组
        Map<String, String> sPara = buildRequestPara(sParaTemp);
        List<String> keys = new ArrayList<String>(sPara.keySet());
        ...
        String path = strUrl + para.substring(0, para.length() - 1);
    ...
    public static String buildRequestRefund(Map<String, String> sParaTemp) throws UnsupportedEncodingException {
        // 待请求参数数组
        Map<String, String> sPara = buildRequestParaRefund(sParaTemp);
        List<String> keys = new ArrayList<String>(sPara.keySet());
