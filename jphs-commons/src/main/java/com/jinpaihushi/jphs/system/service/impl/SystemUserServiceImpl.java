...
public class SystemUserServiceImpl extends BaseServiceImpl<SystemUser> implements SystemUserService {
    ...
    public SystemUser getSystemUser(String userName) {
        boolean result = StringUtils.isNumeric(userName);
        if (!result) {
            boolean ev = StringUtils.contains(userName, "@goldnurse.com");
            if (!ev) {
                userName += "@goldnurse.com";
            }
        }
    ...
    @Override
    public Page<SystemUser> queryList(SystemUser systemUser) {
        return systemUserDao.queryList(systemUser);
    }
