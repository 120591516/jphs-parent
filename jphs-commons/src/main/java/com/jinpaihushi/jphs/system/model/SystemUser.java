...
public class SystemUser extends BaseModel implements Predicate<SystemUser>, Updator<SystemUser> {
    ...
    public String toString() {
        return new StringBuilder().append("SystemUser{").append("id=").append(id).append(",name=").append(name)
                .append(",email=").append(email).append(",password=").append(password).append(",createTime=")
                .append(createTime).append(",creatorId=").append(creatorId).append(",creatorName=").append(creatorName)
                .append(",status=").append(status).append(",phone=").append(phone).append('}').toString();
    }
