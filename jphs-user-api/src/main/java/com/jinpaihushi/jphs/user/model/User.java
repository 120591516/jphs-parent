...
public class User extends BaseModel implements Predicate<User>, Updator<User>, Serializable {
    ...
    public String toString() {
        return new StringBuilder().append("User{").append("id=").append(id).append(",type=").append(type)
                .append(",name=").append(name).append(",sex=").append(sex).append(",phone=").append(phone)
                .append(",password=").append(password).append(",brief=").append(brief).append(",openId=").append(openId)
                .append(",device=").append(device).append(",recommendId=").append(recommendId).append(",createTime=")
                .append(createTime).append(",status=").append(status).append('}').toString();
    }
    ...
    public boolean test(User t) {
        ...
        return (this.id == null || this.id.equals(t.id)) && (this.type == null || this.type.equals(t.type))
                && (this.name == null || this.name.equals(t.name)) && (this.sex == null || this.sex.equals(t.sex))
