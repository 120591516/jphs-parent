...
public class WithdrawCash extends BaseModel implements Predicate<WithdrawCash>,
	...
	private Date auditTime;
	 ...
	 /** 审核人ID */
	@Length(max = 50, message = "{withdrawCash.auditUserId.illegal.length}")
	private String auditUserId;

    /** 审核人姓名 */
	@Length(max = 50, message = "{withdrawCash.auditUserName.illegal.length}")
	...
	private List<Order> orderList;
							//transactionList
	private List<com.jinpaihushi.jphs.withdraw.model.Transaction> transactionList;
	...
	public List<com.jinpaihushi.jphs.withdraw.model.Transaction> getTransactionList() {
    	return transactionList;
    }
  	
	public void setTransactionList( List<com.jinpaihushi.jphs.withdraw.model.Transaction> transactionList) {
