...
public class CustomService extends BaseModel implements Predicate<CustomService>, Updator<CustomService> {
    ...
    public String toString() {
        return new StringBuilder().append("CustomService{").append("id=").append(id).append(",name=").append(name)
                .append(",companyName=").append(companyName).append(",type=").append(type).append(",phone=")
                .append(phone).append(",createTime=").append(createTime).append(",source=").append(source)
                .append(",visitTime=").append(visitTime).append(",visitor=").append(visitor).append(",status=")
                .append(status).append(",remark=").append(remark).append('}').toString();
    }
    ...
    public boolean test(CustomService t) {
        ...
        return (this.id == null || this.id.equals(t.id)) && (this.name == null || this.name.equals(t.name))
                ...
                && (this.type == null || this.type.equals(t.type)) && (this.phone == null || this.phone.equals(t.phone))
