...
public class Order extends BaseModel implements Predicate<Order>, Updator<Order> {
    ...
    /** 活动id */
    @Length(max = 50, message = "{order.activityPromotionId.illegal.length}")
    ...
    private com.jinpaihushi.jphs.withdraw.model.Transaction transactions;
    ...
    /** 来源链接 */
    @Length(max = 65535, message = "{order.sourceLink.illegal.length}")
    ...
    public com.jinpaihushi.jphs.withdraw.model.Transaction getTransactions() {
        return transactions;
    }

    public void Transactions(com.jinpaihushi.jphs.withdraw.model.Transaction transactions) {
