$(document).ready(
		function() {
			...
			var weekOption = pushOption('注册量周统计', weekDeviceName, weekTimeList, weekSeries)
			// 为echarts对象加载数据
			...
			var monthOption = pushOption('注册量月统计', monthDeviceName, monthTimeList, monthSeries)
			// 为echarts对象加载数据
			...
			var yearOption = pushOption('注册量年统计', yearDeviceName, yearTimeList, yearSeries)
			// 为echarts对象加载数据
