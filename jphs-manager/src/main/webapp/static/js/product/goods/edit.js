...
function allowRelease() {
	$("#isRelease_false").attr("checked", false);
	$("#isRelease_true").attr("disabled", false);
	$("#isRelease_true").attr("checked", true);
	$("#isGrabSingle").show();
 ...
 * 不允许发布
 */
function vetoRelease() {
	$("#isRelease_true").attr("checked", false);
	$("#isRelease_true").attr("disabled", true);
	$("#isRelease_false").attr("checked", true);
	$("#isGrabSingle").hide();
}
function addTd(id){
