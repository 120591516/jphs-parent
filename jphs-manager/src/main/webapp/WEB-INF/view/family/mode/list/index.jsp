...
<div class="common_right_title">
	<img src="/static/images/yousanjiaox.png" />家庭护士<i class="public1-horn-45"></i>获取方式管理<i class="public1-horn-45"></i>家庭护士获取方式列表
</div>
...
<div class="marage_right_content">
	<!-- 左对齐按钮 -->
	<jphs:hasPermission url="/family/mode/redirectAddPage.jhtml">
