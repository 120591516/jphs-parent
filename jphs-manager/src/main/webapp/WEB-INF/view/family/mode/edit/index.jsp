...
<div class="common_right_title">
	<img src="/static/images/yousanjiaox.png" />家庭护士<i class="public1-horn-45"></i>获取方式管理<i class="public1-horn-45"></i>
			新建获取方式
</div>
<form class="form-horizontal" id="productForm" method="post" data-role="validate-form" action="/family/mode/insert.jhtml">
