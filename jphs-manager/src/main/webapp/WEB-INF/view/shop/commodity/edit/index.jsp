...
<div class="common_right_title">
	<img src="/static/images/yousanjiaox.png" />产品管理<i class="public1-horn-45"></i>商品管理 <i class="public1-horn-45"></i>${commodity.id == null?'添加商品':'编辑商品'}
</div>


<form class="form-horizontal add_body" id="goodsForm" method="post" data-role="validate-form" action="/commodity/insert.jhtml">
	<div class="marage_right_content">
		<div class="clearfix">
			<jphs:hasPermission url="/commodity/insert.jhtml">
