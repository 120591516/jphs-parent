...
<div class="clearfix">
	...
	<tbody>
		...
		<%-- 	<td>
			...
			<td width="70">
				...
				<select class="form-control input-xlarge" id="ctpId"
					name="ctpId" value="" onchange="change(this.options[this.options.selectedIndex].value)" style="width: 74.56%;">
					<option >请选择</option>
			...
			<select class="form-control input-xlarge" id="ctId"
					name="commodityTypeId" style="margin-left: -43px;width: 150%;">
			...
			<td>
						...
						<div style="width:90%" class="input-group date form_date col-md-3" data-date="" data-date-format="yyyy-mm-dd" data-link-field="workYears" data-link-format="yyyy-mm-dd">
		...
		<td colspan="2" >
						<div style="width:74%;margin-left: -77px; " class="input-group date form_date col-md-3" data-date="" data-date-format="yyyy-mm-dd" data-link-field="workYears" data-link-format="yyyy-mm-dd">
