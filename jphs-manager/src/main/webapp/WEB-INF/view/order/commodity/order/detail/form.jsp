		...
		<tr>
			...
			src="${e.url}"></td>
							...
							<td class="title_value">
								<fmt:formatNumber value="${e.number*e.price }" type="currency"/>
							</td>
												...
												<div class="controls col-md-6"
													...
													<div class='col-lg-8 col-md-8 col-sm-8 col-xs-8' id='tkInfo'>
														<p>
															...
															<input type="hidden"id="totalMoney" name="totalMoney" value="${e.number*e.price }">
														...
														<p>
															退款金额：<input id="amount" name="amount"  value="${e.number*e.price }">元
