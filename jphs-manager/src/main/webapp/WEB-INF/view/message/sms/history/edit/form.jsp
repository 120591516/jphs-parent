	...
	<fieldset>
		...
		<div class="form-group">
			...
			<div class="controls col-md-6"  id="d2" style="display: none;">
				<select class="form-control input-xlarge" id="smsTemplateId2" name="smsTemplateId" onchange="sl2()" style="float: left">
		...
		<div class="form-group">
          ...
          <div class="controls col-md-6">
            <div class="textarea">
                  <textarea id="phone" name="phone" placeholder="请输入接收者手机号  最多不超过250个字" maxlength="60000" class="form-control" style="height: 150px;width: 500px;" >${smsHistory.phone }</textarea>
           			 <span><a href="#"  onclick="F_Open_dialog()"><img alt="" src="https://jinpai.b0.upaiyun.com/upload/JP20171125190445-54247.png"></a></span><br>
           			 ・请上传xlsx格式文件，<span style="color: #0099FF"><a href="http://download.taobaocdn.com/freedom/26568/compress/example.zip?spm=a3142.10692679.3.7.19e53a63HC1fVk&file=example.zip">下载范例</a></span><br>
         ...
         <input type="file" name="file" id="file" onchange="doUpload()" style="width: 0px;height: 0px;"/>
          </div>
