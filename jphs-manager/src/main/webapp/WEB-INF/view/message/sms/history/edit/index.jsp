...
<div style="margin: 10px 10px 10px 10px;">
	<div class="common_right_title">
			<img src="/static/images/yousanjiaox.png" />信息管理<i class="public1-horn-45"></i>短信中心 <i class="public1-horn-45"></i>发送短信
		</b>
	...
	<div class="marage_right_content">
		...
		<button id="save" class="public-info public_btn public_btn_right" data-role="save-btn" style="margin-right:50px;">立即发送</button>
	    </div>
	</div>
</form>
</div>
