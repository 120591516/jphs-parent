...
<div class="details_box clearfix">
	<p class="details_box_xinxi">基本信息1</p>
...
<div class="pageBeijing"></div>
	...
	<%-- 	<p class="example" style=" width:200px;">
			<img alt="" class="img-rounded"   id="head_portraits"
				src="${nurseJobtitle.sculpture }">
		</p>
		<p class="example" style=" width:100px;float:left">
...
<div class="from-group">
	<table id="dateTable"  style="width:900px" class="data_table">
		<thead>
			<tr>
				<th width="30"></th>
				<th>审核结果</th>
