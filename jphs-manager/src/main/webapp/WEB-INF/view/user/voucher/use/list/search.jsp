...
<div class="clearfix">
	<table class="text-right ">
		<tr>
			<td>用户昵称：</td>
			<td width="200">
				<input type="text" name="user.name" id="userName" value="${voucherUse.user.name}" />
			</td>
			<td>手机号：</td>
			<td width="200">
				<input type="text" name="user.phone" id="userPhone" value="${voucherUse.user.phone}" />
			</td>
			<td>用户id：</td>
			<td width="200">
				<input type="text" name="user.id" id="id" value="${voucherUse.user.id}" />
			</td>
		</tr>
		<tr>
			<td>批次号：</td>
			<td width="200">
				<input type="text" name="voucherRepertory.voucher.batchNo" id="creatorName" value="${voucherUse.voucherRepertory.voucher.batchNo}" />
			</td>
			<td>卡号：</td>
			<td width="200">
				<input type="text" name="voucherRepertory.no" id="id" value="${voucherUse.voucherRepertory.no}" />
			</td>
		</tr>
		<tr>
			<td>优惠券状态：</td>
			<td width="200">
				<select class="form-control input-xlarge" id="status"
					...
					<option value="0" <c:if test="${voucherUse.status == 0}">selected="selected"</c:if>>未使用</option>
					<option value="1" <c:if test="${voucherUse.status == 1}">selected="selected"</c:if>>已使用</option>
					<option value="-1" <c:if test="${voucherUse.status == -1}">selected="selected"</c:if>>已停用</option>
				</select>
			</td>
			<td>优惠券类型：</td>
			<td width="200">
