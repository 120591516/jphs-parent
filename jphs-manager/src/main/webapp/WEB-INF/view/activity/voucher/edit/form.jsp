	...
	<div class="title_defalt"></div>
		<input type="hidden" id="goodsId" name="goodsId">
			...
			<div class="form-group">
	          <label class="control-label col-md-3" for="input01">优惠券名称：</label>
		...
		<div class="form-group">
          ...
          <div class="controls  col-md-6">
            ...
            <label class="radio  radio-inline">
              <input type="radio" value="1" checked="checked" name="productType" onclick="showProcuct()">
              	服务
            </label>
            <label class="radio radio-inline">
              <input type="radio" value="2" name="productType"  onclick="showCom()">
              	商品
            </label>
            <label class="radio radio-inline">
        ...
        <div class="form-group" id="support" style="display: none">
          ...
          <div class="controls  col-md-6">
            ...
            <label class="radio  radio-inline">
              <input type="radio" value="1" checked="checked" name="supportType" onclick="showComTree()"> <!-- onclick="showProcuct()" -->
              	商品券
            </label>
            <label class="radio radio-inline">
              <input type="radio" value="2" name="supportType" onclick="showBusTree()"><!-- onclick="showCom()" -->
              	商家券
            </label>
            <label class="radio radio-inline">
              <input type="radio" value="3" name="supportType" onclick="noTree()" ><!-- onclick="showCom()" -->
              	通用券
            </label>
          </div>
        </div>
          ...
          <div class="controls col-md-6">
          	<div 
				...
				<input class="form-control" id="startTime"
					name="startTime"
					size="14" placeholder="请选择兑换开始时间" type="text" value="" readonly style="width: 277px">
          ...
          <div class="controls col-md-6">
           	<div 
				...
				<input class="form-control" id="endTime"
					name="endTime"
					size="14" placeholder="请选择兑换结束时间" type="text" value="" readonly style="width: 277px">
				<span class="input-group-addon"><span
					class="glyphicon glyphicon-remove" title="清空"></span></span> <!-- <span
					class="input-group-addon"><span
					class="glyphicon glyphicon-calendar" title="选择日期"></span></span> --> 
		...
		<div class="controls col-md-6">
			<div class="input-group date form_date col-md-3"
				...
				<input class="form-control" id="activationStartTime" name="activationStartTime" size="14"
					placeholder="请选择激活开始时间" type="text" value="" readonly style="width: 277px"> <span
					class="input-group-addon"><span
					class="glyphicon glyphicon-remove" title="清空"></span></span> <!-- <span
					class="input-group-addon"><span
					class="glyphicon glyphicon-calendar" title="选择日期"></span></span> -->
		...
		<div class="controls col-md-6">
			<div  class="input-group date form_date col-md-3"
				...
				<input class="form-control" id="activationEndTime" name="activationEndTime" size="14"
					placeholder="请选择激活结束时间" type="text" value="" readonly style="width: 277px"> <span
					class="input-group-addon"><span
					class="glyphicon glyphicon-remove" title="清空"></span></span><!--  <span
					class="input-group-addon"><span
					class="glyphicon glyphicon-calendar" title="选择日期"></span></span> -->
