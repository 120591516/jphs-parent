...
<div class="clearfix">
	<table class="text-right ">
		<tr>
			<td>批次编号：</td>
			<td width="200">
				<input type="text" style="width: 240px" name="batchNo" id="batchNo" value="${voucher.batchNo}" />
			</td>
		...
		<tr>
			 ...
			 <td>创建时间：</td>
				<td width="250"><div class="form-group">
						...
						<td>
							<div style="width: 90%;margin-left: -60px">--</div>
						</td>
						<td    width="250">
						<div style="width: 100%;margin-left: -68px;"
							class="input-group date form_date col-md-3" data-date=""
							data-date-format="yyyy-mm-dd" data-link-field="workYears"
							data-link-format="yyyy-mm-dd">
