...
<div class="common_right_title">
	<img src="/static/images/yousanjiaox.png" />活动管理<i class="public1-horn-45"></i>特价管理列<i class="public1-horn-45"></i>特价管理列表 
</div>
...
<div class="marage_right_content">
	<!-- 左对齐按钮 -->
	<jphs:hasPermission url="/activity/promotion/redirectAddPage.jhtml">
