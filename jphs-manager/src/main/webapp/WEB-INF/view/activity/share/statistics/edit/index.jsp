...
<div style="margin: 10px 10px 10px 10px;">
	...
	<form class="add_body" id="shareStatisticsForm" method="post" data-role="validate-form"
		action="/share/statistics/insert.jhtml">
		<div class="tool_form">
			<div class="wf_btn_left">
				<afocus:privilege url="/share/statistics/save.jhtml">
