...
<div id="annual-quantity-year">
	<div class="marage_right_title">
		<div class="form-group" style="background: #fff">
			...
			<jphs:hasPermission url="/jkwy/order/quantityByAnnual.jhtml">
			<button id="annual-next-year" class="search_btn"
				value="/jkwy/order/quantityByAnnual.jhtml" style="display: none;">下一年</button>
			</jphs:hasPermission>
			&nbsp;&nbsp;
			...
			<button id="annual-last-year" class="search_btn"
				value="/jkwy/order/quantityByAnnual.jhtml">上一年</button>
			</jphs:hasPermission>
		</div>
	</div>
