...
<div id="quantity-week">
	<div class="marage_right_title">
		...
		<div class="form-group" style="background: #fff">
			<jphs:hasPermission url="/person/statistics/nurseRegisterByWeek.jhtml">
			<button id="next-week" class="search_btn" value="/person/statistics/nurseRegisterByWeek.jhtml">下一周</button>
			</jphs:hasPermission>
			&nbsp;&nbsp;
			<button id="this-week" class="search_btn" style="width: 110px;"></button>
			&nbsp;&nbsp;
			<jphs:hasPermission url="/person/statistics/nurseRegisterByWeek.jhtml">
			<button id="last-week" class="search_btn" value="/person/statistics/nurseRegisterByWeek.jhtml">上一周</button>
			</jphs:hasPermission>
		</div>
	</div>
