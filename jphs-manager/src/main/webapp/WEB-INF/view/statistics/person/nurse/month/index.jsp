...
<div id ="quantity-month">
	<div class="marage_right_title">
		<div class="form-group" style="background: #fff">
			<jphs:hasPermission url="/person/statistics/nurseRegisterByMonth.jhtml">
			<button id="next-month" class="search_btn" value="/person/statistics/nurseRegisterByMonth.jhtml">下一月</button>
			</jphs:hasPermission>
			&nbsp;&nbsp;
			<button id="this-month" class="search_btn" style="width: 40px;"></button>
			&nbsp;&nbsp;
			<jphs:hasPermission url="/person/statistics/nurseRegisterByMonth.jhtml">
			<button id="last-month" class="search_btn" value="/person/statistics/nurseRegisterByMonth.jhtml">上一月</button>
			</jphs:hasPermission>
		</div>
	</div>
