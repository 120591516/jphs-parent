...
<div style="margin: 10px 10px 10px 10px;">
	...
	<form class="add_body" id="jkwyRelationForm" method="post" data-role="validate-form"
		action="/jkwy/relation/insert.jhtml">
		<div class="tool_form">
			<div class="wf_btn_left">
				<afocus:privilege url="/jkwy/relation/save.jhtml">
