...
<div class="common_right_title">
	<img src="/static/images/yousanjiaox.png" />健康无忧<i class="public1-horn-45"></i>套餐管理<i class="public1-horn-45"></i>套餐列表
</div>
...
<div class="marage_right_content">
	<!-- 左对齐按钮 -->
	<jphs:hasPermission url="/jkwy/package/redirectAddPage.jhtml">
