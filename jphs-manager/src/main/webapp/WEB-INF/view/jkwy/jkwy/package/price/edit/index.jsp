...
<div style="margin: 10px 10px 10px 10px;">
	...
	<form class="add_body" id="jkwyPackagePriceForm" method="post" data-role="validate-form"
		action="/jkwy/package/price/insert.jhtml">
		<div class="tool_form">
			<div class="wf_btn_left">
				<afocus:privilege url="/jkwy/package/price/save.jhtml">
