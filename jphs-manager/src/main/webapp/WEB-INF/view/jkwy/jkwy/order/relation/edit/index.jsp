...
<div style="margin: 10px 10px 10px 10px;">
	...
	<form class="add_body" id="jkwyOrderRelationForm" method="post" data-role="validate-form"
		action="/jkwy/order/relation/insert.jhtml">
		<div class="tool_form">
			<div class="wf_btn_left">
				<afocus:privilege url="/jkwy/order/relation/save.jhtml">
