...
<div style="margin: 10px 10px 10px 10px;">
	...
	<form class="add_body" id="jkwyTimeAxisForm" method="post" data-role="validate-form"
		action="/jkwy/time/axis/insert.jhtml">
		<div class="tool_form">
			<div class="wf_btn_left">
				<afocus:privilege url="/jkwy/time/axis/save.jhtml">
