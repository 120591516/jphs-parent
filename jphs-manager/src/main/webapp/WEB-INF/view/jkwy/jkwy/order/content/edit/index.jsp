...
<div style="margin: 10px 10px 10px 10px;">
	...
	<form class="add_body" id="jkwyOrderContentForm" method="post" data-role="validate-form"
		action="/jkwy/order/content/insert.jhtml">
		<div class="tool_form">
			<div class="wf_btn_left">
				<afocus:privilege url="/jkwy/order/content/save.jhtml">
