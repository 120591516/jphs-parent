...
<div class="common_right_title">
	<img src="/static/images/yousanjiaox.png" />健康无忧<i
		class="public1-horn-45"></i>销售人员管理<i class="public1-horn-45"></i>${jkwyCode.id == null?'添加销售人员':'编辑销售人员'}
</div>
<form class="form-horizontal add_body" id="jkwyPackageForm" method="post" data-role="validate-form"
	action="/jkwy/code/insert.jhtml">
	<div class="marage_right_content">
		<div class="clearfix">
			<jphs:hasPermission url="/jkwy/code/insert.jhtml">
