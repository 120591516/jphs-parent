...
<div style="margin: 10px 10px 10px 10px;">
	...
	<form class="add_body" id="jkwyPackageContentForm" method="post" data-role="validate-form"
		action="/jkwy/package/content/insert.jhtml">
		<div class="tool_form">
			<div class="wf_btn_left">
				<afocus:privilege url="/jkwy/package/content/save.jhtml">
