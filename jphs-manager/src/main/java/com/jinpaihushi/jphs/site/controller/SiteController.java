...
public class SiteController extends BaseController<Site> {
    ...
    @RequestMapping(name = "获取所有站点", path = "/getSiteAllList.json")
    @ResponseBody
    public JSONObject getSiteAllList(HttpSession hs, HttpServletRequest req, HttpServletResponse resp, Site site) {
    	JSONObject json = new JSONObject();
    	site.setStatus(1);
    	site.setOrderby("S.create_time DESC");
		List<Map<String,Object>> s = siteService.getSiteAllList(site);
		json.put("site", s);
		return json;
    }
